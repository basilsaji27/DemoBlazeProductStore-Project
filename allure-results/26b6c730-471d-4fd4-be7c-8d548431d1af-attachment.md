      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox "Username:" [ref=e12]: bas2711
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox "Password:" [ref=e15]: bas2711
        - generic [ref=e17]:
...
```ts
  ...
  21 |         await this.signupusername.fill(signupCreds.username)
  22 |         await this.signuppassword.fill(signupCreds.password)
...
> 31 |         expect(successAlertMsg).toBe('Sign up successful.');
  ...
  36 |         await this.signupusername.fill(signupCreds.username)
  37 |         await this.signuppassword.fill(signupCreds.password)
